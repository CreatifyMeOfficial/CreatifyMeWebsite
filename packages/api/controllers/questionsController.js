...
const DeleteQuestion = async (req, res) => {
  ...
  if (!question) {
    throw new NotFoundError(`This question doesn't exists!`);
  }
...
const CalculateResults = async (req, res) => {
  ...
  answers.forEach(answer => {
    ...
    if (!question) {
      throw new BadRequestError('This question does not exists');
    }
...
const GetUserResult = async (req, res) => {
  ...
  if (!result) {
    throw new NotFoundError(`This user doesn't have a result yet`);
  }
