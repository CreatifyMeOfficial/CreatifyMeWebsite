...
<template>
  <div class="container">
    <div class="code-placeholder" v-show="isLoadingResult && !isNotificationBoxVisible"></div>
    <h1 class="title" v-show="!isLoadingResult && !isNotificationBoxVisible">{{ result.code }}</h1>
    <div class="buttom" v-show="isLoadingResult && !isNotificationBoxVisible"></div>

    <div class="result-part">
      <div class="par" v-show="isLoadingResult && !isNotificationBoxVisible"></div>
      <p v-show="!isLoadingResult && !isNotificationBoxVisible">{{ description[resultField][0] }}</p>
      <div class="second-result-part">
        <div class="one" v-show="isLoadingResult && !isNotificationBoxVisible">
          <div class="left" v-show="isLoadingResult && !isNotificationBoxVisible"></div>
          <div class="image" v-show="isLoadingResult && !isNotificationBoxVisible"></div>
        </div>
        <div v-show="!isLoadingResult && !isNotificationBoxVisible">
          <p>{{ description[resultField][1] }}</p>
          <img src="../assets/Images/SVG/res1.png" alt="" />
        </div>

        <div class="two" v-show="isLoadingResult && !isNotificationBoxVisible">
          <div class="image"></div>
          <div class="left"></div>
        </div>
        <div>
          <img v-show="!isLoadingResult && !isNotificationBoxVisible" src="../assets/Images/SVG/res2.png" alt="" />
          <p>{{ description[resultField][2] }}</p>
        </div>
        <div class="three" v-show="isLoadingResult && !isNotificationBoxVisible">
          <div class="left"></div>
          <div class="image"></div>
        </div>
        <div>
          <p>{{ description[resultField][3] }}</p>
          <img v-show="!isLoadingResult && !isNotificationBoxVisible" src="../assets/Images/SVG/res3.png" alt="" />
        </div>
      </div>
      <div class="sm" v-show="isLoadingResult && !isNotificationBoxVisible">
        <div class="small"></div>
        <div class="small"></div>
        <div class="small"></div>
        <div class="small"></div>
...
@media (max-width: 767px) {
  ...
  .result-part .second-result-part div:nth-child(2) {
