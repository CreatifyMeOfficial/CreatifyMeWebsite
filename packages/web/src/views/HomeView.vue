...
<template>
  ...
  <div class="home-user-review">
    ...
    <div class="user-list">
      ...
      ></UserReview>
      <div class="placeholder" v-for="index in 4" :key="index" v-if="isLoadingComments || comments.length === 0">
  ...
  <div class="home-user-comment">
    ...
    <div class="user-comment">
      ...
      <input type="text" id="comment" :placeholder="t('comments.placeholder')" />
      <customButtonComponent
        class="comment-btn"
        :buttonType="'button'"
