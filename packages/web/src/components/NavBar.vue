...
async function logout() {
  try {
    ...
    userStore.clearUser()
    createNotification('Logged out successfully!', notificationTypes.Success, 5)
  } catch {
    createNotification('Something went wrong! Please try again later.', notificationTypes.Error, 5)
  }
}
...
.profile-dropdown {
  ...
  height: 0;
  overflow: hidden;
  box-shadow: 0px 2px 3px 0 #161719;
}
