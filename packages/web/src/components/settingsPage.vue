...
const updatePassword = async () => {
  if (
    ...
    if (response.status === 200) {
      createNotification('Password updated successfully!', notificationTypes.Success, 5)
      oldPassword.value = ''
      newPassword.value = ''
      confirmPassword.value = ''
    }
...
const deleteMyAccount = async () => {
  ...
  if (response.status === 200) {
    userStore.clearUser()
    createNotification('Account deleted successfully!', notificationTypes.Success, 5)
  }
}
  ...
  <div class="settings-container">
    ...
    <div class="settings-notific">
      ...
      <div class="notific-option">
        ...
        <input type="checkbox" id="notific" />
