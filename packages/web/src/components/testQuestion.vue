      ...
      <div class="answers">
        <span class="answer"
          ><input
            ...
            v-bind:checked="savedSelection === '1'"
            :name="number"
            type="radio"
        /></span>
        <span class="answer"
          ><input
            value="2"
            v-model="selectedValue"
            v-bind:checked="savedSelection === '2'"
            :name="number"
            type="radio"
        /></span>
        <span class="answer"
          ><input
            ...
            v-model="selectedValue"
            :name="number"
            v-bind:checked="savedSelection === '3'"
            type="radio"
        /></span>
        <span class="answer"
          ><input
            value="4"
            v-model="selectedValue"
            v-bind:checked="savedSelection === '4'"
            :name="number"
            type="radio"
        /></span>
        <span class="answer"
          ><input
            value="5"
            v-model="selectedValue"
            v-bind:checked="savedSelection === '5'"
            :name="number"
            type="radio"
        /></span>
      </div>
